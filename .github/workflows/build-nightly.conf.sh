...
# ============= SCCACHE ==============  
ac_add_options --with-ccache="$HOME/.mozbuild/buildcache/bin/buildcache"
...
# ========== RUST ==========    
export RUST_BIN_PATH="$HOME/.rustup/toolchains/1.90.0-custom-x86/bin"
...
# ========== OPTIMIZATIONS ==========   
# ac_add_options --disable-crashreporter    # Restore crashreporter since 140.16.0esr-mj
...
# ac_add_options --enable-optimize="-Og -w"
